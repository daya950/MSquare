...
var encodedString = Base64.encode('http://light-bigcommerce-stencil-theme.mybigcommerce.com');
alert(encodedString);
if(encodedString=='bGlnaHQtYmlnY29tbWVyY2Utc3RlbmNpbC10aGVtZS5teWJpZ2NvbW1lcmNlLmNvbQ==') {
    alert('true');
} else {
    false;
}
