$(document).ready(function() {
    ...
    var encodedString = Base64.encode($(location).attr('hostname'));
    if((encodedString=="aHR0cDovL2xpZ2h0LWJpZ2NvbW1lcmNlLXN0ZW5jaWwtdGhlbWUubXliaWdjb21tZXJjZS5jb20=") || (encodedString == "bGlnaHQtYmlnY29tbWVyY2Utc3RlbmNpbC10aGVtZS5teWJpZ2NvbW1lcmNlLmNvbQ=")) {
        var arr = [];
